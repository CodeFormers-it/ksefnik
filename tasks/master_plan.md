...
- [ ] **T06 — @ksefnik/core: Validation Engine** (2 subtaski)
  - [ ] [T06.1 — Framework & first 10 rules](./plans/T06-validation.md#t061)
...
- [ ] **T09 — @ksefnik/simulator** (2 subtaski)
  - [ ] [T09.1 — Mock adapter & scenario infrastructure](./plans/T09-simulator.md#t091)
...
- [ ] **T11 — @ksefnik/cli** (3 subtaski)
  - [ ] [T11.1 — CLI framework & commands: fetch, send](./plans/T11-cli.md#t111)
...
- [ ] **T12 — Integration Tests, Examples & Build** (3 subtaski)
  - [ ] [T12.1 — End-to-end integration tests](./plans/T12-integration.md#t121)
